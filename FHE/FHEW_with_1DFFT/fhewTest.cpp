...
// extern int acc_cnt, fft_fwd_count, fft_back_count, homNand;
...
int main(int argc, char *argv[]) {
 ...
 /* cout<<"AddToAcc occured "<<acc_cnt<<" times.."<<endl;
  cout<<"Number of times FFTForward occured = "<<fft_fwd_count<<endl;
  cout<<"Number of times FFTBackward occured = "<<fft_back_count<<endl;
  cout<<"Number of homomorphic NAND = "<<homNand<<endl;*/
  cerr << "\nPassed all tests!\n\n";
}
