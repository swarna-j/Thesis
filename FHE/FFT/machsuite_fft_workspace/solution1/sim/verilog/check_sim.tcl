...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fft.autotvin_real_r.dat"
         "c.fft.autotvin_img.dat"
         "c.fft.autotvin_real_twid.dat"
         "c.fft.autotvin_img_twid.dat"
         "c.fft.autotvout_real_r.dat"
         "c.fft.autotvout_img.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fft.autotvout_real_r.dat"
         "rtl.fft.autotvout_img.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
