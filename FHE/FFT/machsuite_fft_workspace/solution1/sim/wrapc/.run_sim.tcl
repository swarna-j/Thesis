...
set ::env(LD_LIBRARY_PATH) /home/jsk_027/Vivado_HLS/2016.4/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jsk_027/Vivado_HLS/2016.4/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jsk_027/Vivado_HLS/2016.4/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jsk_027/Vivado_HLS/2016.4/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jsk_027/Vivado_HLS/2016.4/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft.autotvin.dat"
	set constFileTvOut       "fft.autotvout.dat"
	set constFileHdlTvIn     "fft.autohdltvin.dat"
	set constFileHdlTvOut    "fft.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
