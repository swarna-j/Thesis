#pragma line 1 "/home/jsk_027/Thesis/MachSuite/fft/strided/fft.c"
...
#pragma line 2 "/home/jsk_027/Thesis/MachSuite/fft/strided/fft.c" 2
#pragma empty_line
void fft(double real[1024], double img[1024], double real_twid[1024/2], double img_twid[1024/2]){
    ...
    log = 0;
#pragma empty_line
    outer:for(span=1024>>1; span; span>>=1, log++){
        inner:for(odd=span; odd<1024; odd++){
            odd |= span;
            even = odd ^ span;
#pragma empty_line
