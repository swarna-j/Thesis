...
set C_modelArgList {
	{ real_r double 64 regular {array 1024 { 2 2 } 1 1 }  }
	{ img double 64 regular {array 1024 { 2 2 } 1 1 }  }
	{ real_twid double 64 regular {array 512 { 1 3 } 1 1 }  }
	{ img_twid double 64 regular {array 512 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ real_r_address1 sc_out sc_lv 10 signal 0 } 
	{ real_r_ce1 sc_out sc_logic 1 signal 0 } 
	{ real_r_we1 sc_out sc_logic 1 signal 0 } 
	{ real_r_d1 sc_out sc_lv 64 signal 0 } 
	{ real_r_q1 sc_in sc_lv 64 signal 0 } 
	...
	{ img_address1 sc_out sc_lv 10 signal 1 } 
	{ img_ce1 sc_out sc_logic 1 signal 1 } 
	{ img_we1 sc_out sc_logic 1 signal 1 } 
	{ img_d1 sc_out sc_lv 64 signal 1 } 
	{ img_q1 sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "real_r_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "real_r", "role": "address1" }} , 
 	{ "name": "real_r_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "real_r", "role": "ce1" }} , 
 	{ "name": "real_r_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "real_r", "role": "we1" }} , 
 	{ "name": "real_r_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "real_r", "role": "d1" }} , 
 	{ "name": "real_r_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "real_r", "role": "q1" }} , 
 	...
 	{ "name": "img_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "img", "role": "address1" }} , 
 	{ "name": "img_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img", "role": "ce1" }} , 
 	{ "name": "img_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img", "role": "we1" }} , 
 	{ "name": "img_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "img", "role": "d1" }} , 
 	{ "name": "img_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "img", "role": "q1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "51221", "Max" : "235541"}
	, {"Name" : "Interval", "Min" : "51222", "Max" : "235542"}
]}

set Spec2ImplPortList { 
	real_r { ap_memory {  { real_r_address0 mem_address 1 10 }  { real_r_ce0 mem_ce 1 1 }  { real_r_we0 mem_we 1 1 }  { real_r_d0 mem_din 1 64 }  { real_r_q0 mem_dout 0 64 }  { real_r_address1 mem_address 1 10 }  { real_r_ce1 mem_ce 1 1 }  { real_r_we1 mem_we 1 1 }  { real_r_d1 mem_din 1 64 }  { real_r_q1 mem_dout 0 64 } } }
	img { ap_memory {  { img_address0 mem_address 1 10 }  { img_ce0 mem_ce 1 1 }  { img_we0 mem_we 1 1 }  { img_d0 mem_din 1 64 }  { img_q0 mem_dout 0 64 }  { img_address1 mem_address 1 10 }  { img_ce1 mem_ce 1 1 }  { img_we1 mem_we 1 1 }  { img_d1 mem_din 1 64 }  { img_q1 mem_dout 0 64 } } }
