...
@p_str2 = private unnamed_addr constant [6 x i8] c"inner\00", align 1
@p_str1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@p_str = private unnamed_addr constant [6 x i8] c"outer\00", align 1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([6 x i8]* @p_str) nounwind
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_13 = call i32 (...)* @_ssdm_op_SpecRegionBegin([6 x i8]* @p_str2) nounwind
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 512, i32 1024, i32 768, [1 x i8]* @p_str1) nounwind
...
._crit_edge:                                      ; preds = %5, %4
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([6 x i8]* @p_str2, i32 %tmp_13) nounwind
  %odd_2 = add nsw i32 %odd_1, 1
  br label %3

; <label>:6                                       ; preds = %3
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([6 x i8]* @p_str, i32 %tmp_8) nounwind
