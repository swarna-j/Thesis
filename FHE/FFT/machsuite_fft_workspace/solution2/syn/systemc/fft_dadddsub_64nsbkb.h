...
#ifndef __fft_dadddsub_64nsbkb__HH__
#define __fft_dadddsub_64nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_dadddsub_64nsbkb) {
    ...
    SC_CTOR(fft_dadddsub_64nsbkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
