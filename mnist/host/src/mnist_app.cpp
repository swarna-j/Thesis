...
int main(int argc, char **argv) {
	...
	cout << "MNIST Digit Classification using OpenCL\n";
...
unsigned int runApplication() {
	...
	const double app_start = getCurrentTimestamp();
...
//------------------------------------------Code added for benchmarking----------------------------------------------------
        const double app_end = getCurrentTimestamp();
        const double app_total = app_end - app_start;
        cout << "\nOpenCL Kernel Total Runtime(ms): " << app_total * 1e3 << endl;
	
        clWaitForEvents(1, &kernel_event[0]);
        clWaitForEvents(1, &kernel_event[1]);
        clWaitForEvents(1, &kernel_event[2]);
        clWaitForEvents(1, &kernel_event[3]);
        clWaitForEvents(1, &kernel_event[4]);
        clWaitForEvents(1, &kernel_event[5]);
        clWaitForEvents(1, &kernel_event[6]); 
        clWaitForEvents(1, &kernel_event[7]);        
        clFinish(queue);
	...
	cl_ulong time_start, time_end;
        ...
        printf("Conv1 Execution time is: %0.3f ms\n",total_time/1000000.0);
        ...
        total_time = time_end-time_start;
        printf("MaxPool1 Execution time is: %0.3f ms\n",total_time/1000000.0);
        ...
        total_time = time_end-time_start;
        printf("Conv2 Execution time is: %0.3f ms\n",total_time/1000000.0);
        ...
        total_time = time_end-time_start;
        printf("MaxPool2 Execution time is: %0.3f ms\n",total_time/1000000.0);
                
        clGetEventProfilingInfo(kernel_event[4], CL_PROFILING_COMMAND_START, sizeof(time_start), &time_start, NULL);
        clGetEventProfilingInfo(kernel_event[4], CL_PROFILING_COMMAND_END, sizeof(time_end), &time_end, NULL);
        total_time = time_end-time_start;
        printf("IP1 Execution time is: %0.3f ms\n",total_time/1000000.0);
	
        clGetEventProfilingInfo(kernel_event[5], CL_PROFILING_COMMAND_START, sizeof(time_start), &time_start, NULL);
        clGetEventProfilingInfo(kernel_event[5], CL_PROFILING_COMMAND_END, sizeof(time_end), &time_end, NULL);
        total_time = time_end-time_start;
        printf("ReLU Execution time is: %0.3f ms\n",total_time/1000000.0);
        
        clGetEventProfilingInfo(kernel_event[6], CL_PROFILING_COMMAND_START, sizeof(time_start), &time_start, NULL);
        clGetEventProfilingInfo(kernel_event[6], CL_PROFILING_COMMAND_END, sizeof(time_end), &time_end, NULL);
        total_time = time_end-time_start;
        printf("IP2 Execution time is: %0.3f ms\n",total_time/1000000.0);
        
        clGetEventProfilingInfo(kernel_event[7], CL_PROFILING_COMMAND_START, sizeof(time_start), &time_start, NULL);
        clGetEventProfilingInfo(kernel_event[7], CL_PROFILING_COMMAND_END, sizeof(time_end), &time_end, NULL);
        total_time = time_end-time_start;
        printf("Softmax Execution time is: %0.3f ms\n",total_time/1000000.0); 
//-----------------------------------------------------------------------------------------------------------------------------	
	DTYPE max_prob = 0.0;
...
void createDeviceBuffer() {
	...
	fc2.d_output = clCreateBuffer(context, CL_MEM_WRITE_ONLY, 
		fc2.top_shape.x * fc2.top_shape.y  * fc2.top_shape.z * sizeof(DTYPE), NULL, &status);
	fc2.d_W = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, 
		fc2.top_shape.x * fc2.bot_shape->x * sizeof(WTYPE), fc2.W, &status); 
	fc2.d_b = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, 
